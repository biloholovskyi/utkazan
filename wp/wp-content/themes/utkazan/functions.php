...
function menu() {
  ...
  add_theme_support( 'post-thumbnails', array('post', 'slider', 'logo', 'catalog', 'principles','politics') );
...
function register_post_types(){
  ...
  register_post_type('politics', array(
    ...
    'labels' => array(
      ...
      'not_found'          => 'Не найден документ политики', // если в результате поиска ничего не было найдено
